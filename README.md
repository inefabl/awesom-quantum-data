...
1. **Nielsen & Chuang (QCQI) Ch.1–2 (textbook excerpt)**  
...
2. **A Single Quantum Cannot Be Cloned (Nature 1982)**  
...
4. **Quantum Storage Design for Tables in RDBMS (QCOS/QROS, QDSM’24)**  
   *Tuodu Li et al., Quantum Storage Design for Tables in RDBMS (QDSM’24).* [[Project](https://www.ifis.uni-luebeck.de/~groppe/qdsm/?page=paper&year=2024&paperid=p2)]  
...
5. **Operational Framework for a Quantum Database (arXiv 2025)**  
   *Rieger et al., Operational Framework for a Quantum Database, arXiv:2405.14947v2, 2025.* [[Project](https://arxiv.org/abs/2405.14947)]  
...
1. **Quantum Algorithms for Element Distinctness (arXiv:quant-ph/0007016)**  
   *Buhrman et al., Quantum Algorithms for Element Distinctness, arXiv:quant-ph/0007016v2 (2000).* [[Project](https://ieeexplore.ieee.org/abstract/document/933880)]  
...
2. **Towards Quantum Data Structures for Enhanced Database Performance (QDSM’24)**  
   *Littau et al., Towards Quantum Data Structures for Enhanced Database Performance (QDSM’24).* [[Project](https://www.vldb.org/workshops/2024/proceedings/QDSM/QDSM.6.pdf)]  
...
2. **Quantum Data Management: From Theory to Opportunities (Tutorial / arXiv 2024)**  
   *Hai, Hung & Feld, Quantum Data Management: From Theory to Opportunities, arXiv:2403.02856v1, 2024.* [[Project](https://ieeexplore.ieee.org/abstract/document/10597772)]  
...
2. **Query Processing on Tensor Computation Runtimes (TQP, PVLDB 2022)**  
   *He et al., Query Processing on Tensor Computation Runtimes, PVLDB 15(11) 2022.* [[DOI](https://doi.org/10.14778/3551793.3551833)]  
...
3. **TQEx: Tensor-based Query Engine Enhanced by Bridging the Gap (SIGMOD 2025)**  
...
4. **Qymera: Simulating Quantum Circuits using RDBMS (SIGMOD-Companion 2025)**  
...
5. **Qute: Towards Quantum-Native Database (arXiv 2026)**  
...
1. **Join Order Optimisation on Quantum Hardware (PVLDB 2022)**  
...
2. **Q2O: Quantum-augmented Query Optimizer (PVLDB 2025 demo)**  
   *Liu et al., PVLDB 18(12) 2025.* [[Code](https://github.com/ihanwen99/Q2O)]  
...
1. **Quantum Annealing Method for Dynamic Virtual Machine and Task Allocation in Cloud Infrastructures from Sustainability Perspective (ICDEW 2023)**  
...
2. **Opportunities for Quantum Acceleration of Databases (PVLDB 2023)**  
   *Çalıkyılmaz et al., PVLDB 16(9) 2023.* [[Code](https://github.com/TobiasWinker/QC4DB_VQC_Tutorial)]  
...
1. **Tensor-Train Decomposition (SIAM J. Sci. Comput. 2011)**  
...
2. **Approximating Tensor Network Contraction with Sketches (arXiv 2026)**  
...
3. **Matrix Product State for Higher-Order Tensor Compression and Classification**  
...
4. **HiCOO: Hierarchical Storage of Sparse Tensors (SC18 paper)**  
...
6. **Tentris – A Tensor-Based Triple Store (ISWC 2020)**  
   *Bigerl et al., Tentris – A Tensor-Based Triple Store (ISWC 2020).* [[Project](https://tentris.dice-research.org/iswc2020)]  
...
7. **TT-Rec: Tensor Train Compression for DLRM Embeddings (MLSys 2021)**  
...
8. **On the Optimal Linear Contraction Order of Tree Tensor Networks, and Beyond (arXiv 2024)**  
...
9. **Optimizing Tensor Programs on Flexible Storage (arXiv 2022)**  
...
10. **Hand-waving and Interpretive Dance: An Introductory Course on Tensor Networks**  
...
11. **ALTO: Adaptive Linearized Storage of Sparse Tensors (ICS 2021)**  
...
12. **Efficient Contraction of Large Tensor Networks for Weighted Model Counting through Graph Decompositions**  
...
13. **A Tensor Based Data Model for Polystore: An Application to Social Networks Data**  
