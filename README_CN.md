...
1. **Quantum Data Management in the NISQ Era (PVLDB 2025)**
   *Hai et al., Quantum Data Management in the NISQ Era, PVLDB 18(6):1720–1729, 2025.* [[Paper](https://doi.org/10.14778/3725688.3725701)] [[Github](https://github.com/InfiniData-Lab/Quantum)]
...
5. **Query Processing on Tensor Computation Runtimes (TQP, PVLDB 2022)**
   *He et al., Query Processing on Tensor Computation Runtimes, PVLDB 15(11) 2022, 10.14778/3551793.3551833.* [[Paper](https://dl.acm.org/doi/10.14778/3551793.3551833)] 
   - **数据模型**：关系模型（SQL→关系代数）
